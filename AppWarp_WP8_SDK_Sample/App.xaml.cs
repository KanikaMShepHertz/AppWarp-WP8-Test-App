...
namespace AppWarp_WP8_SDK_Sample
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            (App.Current as App).notificationOC = new ObservableCollection<string>();
            (App.Current as App).responseOC = new ObservableCollection<string>();
        ...
        private void apiPageBtn_Click(object sender, EventArgs e)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                App.RootFrame.Navigate(new Uri("/APIsPage.xaml", UriKind.Relative));

            });
        }

        private void responsesPageBtn_Click(object sender, EventArgs e)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                App.RootFrame.Navigate(new Uri("/ResponsesPage.xaml", UriKind.Relative));

            });
        }

        private void notificationsPageBtn_Click(object sender, EventArgs e)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                App.RootFrame.Navigate(new Uri("/NotificationsPage.xaml", UriKind.Relative));
